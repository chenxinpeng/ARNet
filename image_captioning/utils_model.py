...
# ==============================================================
with open(opt.train_val_imageNames_to_imageIDs_path, 'rb') as f:
    print('\nload  {}'.format(opt.train_val_imageNames_to_imageIDs_path))
    train_val_imageNames_to_imageIDs = cPickle.load(f)

with open(opt.official_train_captions_path, 'rb') as f:
    print('\nload  {}'.format(opt.official_train_captions_path))
    train_images_captions = cPickle.load(f)

with open(opt.official_val_captions_path, 'rb') as f:
    print('\nload  {}'.format(opt.official_val_captions_path))
    val_images_captions = cPickle.load(f)
